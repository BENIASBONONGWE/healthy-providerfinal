...
package com.example.myprojectfinal.DoctorDetails;
        ...
        import com.example.myprojectfinal.DoctorDetails.AnotherActivity;
        import com.example.myprojectfinal.R;

        import java.util.Calendar;

public class HIVTreatmentActivity extends AppCompatActivity {
    ...
    private Handler bookingResetHandler = new Handler();
        ...
        bookDoctorButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (id != -1) {
                    ...
                    Intent intent = new Intent(com.example.myprojectfinal.DoctorDetails.HIVTreatmentActivity.this, AnotherActivity.class);
